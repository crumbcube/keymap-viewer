...
export const sokuonKomojiData: SokuonKomojiPracticeGroup[] = [
  ...
  { groupName: '小文字や行', chars: ['ゃ', 'ゅ', 'ょ'], inputs: [
      { gyouKey: 'や行', middleKey: '濁音', dan: 'あ段' },
      { gyouKey: 'や行', middleKey: '濁音', dan: 'う段' },
      { gyouKey: 'や行', middleKey: '濁音', dan: 'お段' },
  ], },
  { groupName: '小文字わ行', chars: ['ゎ'], inputs: [
      { gyouKey: 'わ行', middleKey: '濁音', dan: 'あ段' },
  ], },
  { groupName: '小文字か行', chars: ['ヵ', 'ヶ'], inputs: [
      { gyouKey: 'か行', middleKey: '濁音', dan: 'あ段' },
      { gyouKey: 'か行', middleKey: '濁音', dan: 'え段' },
  ], },
...
export const kigoPractice2Data: Kigo2PracticeGroup[] = [
    { groupName: '記号２－１', chars: ['＋', '＿', '＊', 'ー', '＠'], inputs: [ { gyouKey: 'あ行' }, { gyouKey: 'か行' }, { gyouKey: 'さ行' }, { gyouKey: 'た行' }, { gyouKey: 'な行' }, ], },
...
export const youdakuonGyouChars: Record<string, string[]> = {
  'か行': ['ぎゃ', 'ぎゅ', 'ぎょ'],
  'さ行': ['じゃ', 'じゅ', 'じょ'],
  'た行': ['ぢゃ', 'ぢゅ', 'ぢょ'], // 通常の入力では「じゃ」「じゅ」「じょ」と同じになることが多い
  'は行': ['びゃ', 'びゅ', 'びょ'],
};
export const youdakuonDanMapping: Record<string, string[]> = {
  'か行': ['あ段', 'う段', 'お段'],
  'さ行': ['あ段', 'う段', 'お段'],
  'た行': ['あ段', 'う段', 'お段'],
  'は行': ['あ段', 'う段', 'お段'],
};
export const youhandakuonGyouChars: Record<string, string[]> = { 'は行': ['ぴゃ', 'ぴゅ', 'ぴょ'] };
export const youhandakuonDanMapping: Record<string, string[]> = { 'は行': ['あ段', 'う段', 'お段'] };
...
export const sampleJson = {
  ...
  right: {
    ...
    [ // layers[3] かなモード（エンド）
      ...
      "____", "____", "う段", "____", "____",
      "____", "い段", "あ段", "え段", "____",
      "____", "____", "お段", "____", "____"
    ],
    [ // layers[4] 英字モード（スタート）
      "IME ",     "____",     "Caps\nLock", "訂正",  " BS",
      "変換",     "@ - _ \\", "abc",        "def",  "TAB",
...
export const tanbunSentences: string[] = [
  "きょうはいいてんきですね。",
  "わたしのなまえはさとうです。",
  "これはぺんです。",
  "つくえのうえにりんごがあります。",
